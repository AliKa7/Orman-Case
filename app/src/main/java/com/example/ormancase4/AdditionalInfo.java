...
public class AdditionalInfo extends AppCompatActivity {
    ...
    private void init() {
        ...
        instructionItemList.add(new InstructionItem(R.drawable.advice3, "3", "На поверхности вы обнаружите железную крышку с интегрированной ручкой. Откройте ее"));
        instructionItemList.add(new InstructionItem(R.drawable.advice4, "4", "Откройте ящик и доставайте оттуда нужные вам вещи. Внутри есть информационная брошюра, на коробке самоспасателя находится инструкция."));
